            ...
            <menu>
                ...
                <div class="menu__container">
                    ...
                    <div class="menu__item">
                        <a id="analitic__pagination" href="analitics.php">Аналитика</a>
                    </div>
                    <div class="analitic__submenu">
                        <div class="submenu__item">
                            <a class="submenu__item" href="analitics.php">Экономический календарь</a>
                        </div>
                        <div class="submenu__item">
                            <a class="submenu__item" href="analitics.php">Обзор рынка</a>
                        </div>
                        <div class="submenu__item">
                            <a class="submenu__item" href="analitics.php">Курсы валют</a>
                        </div>
                        <div class="submenu__item">
                            <a class="submenu__item" href="analitics.php">Криптовалюты</a>
                        </div>
                    ...
                    <div class="menu__item not-submenu">
                        <a id="menu__leceence" href="#contact__info">Лицензии</a>

                    </div>
                    <div class="menu__item not-submenu">
                        <a id="menu__contacts" href="#contact__info">Контакты</a>
