$(document).ready(() => {
    ...
    $('#menu__contacts').click(() => {
        console.log('sdsdsds');
        $('html, body').animate({
            scrollTop: $('#contact__info').offset().top
        }, 1000);
        $(".menu__container").removeClass("active-menu");
        $('.analitic__submenu').removeClass('active');
        $(".menu__button").removeClass("active-button");
    ...
    $('#liceence').click(() => {
        $(".liceence__container").addClass('active');
    });
    $('.liceence__container').click(() => {
        $(".liceence__container").removeClass('active');
    });
